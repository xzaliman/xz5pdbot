...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ Add Dewi To Your Group ➕️", url="t.me/cybervandalismbot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="About", callback_data="Dewi_"),
        InlineKeyboardButton(
...
yone_IMG = "https://telegra.ph/file/e8badfd010b8b78ac4db0.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @xz5pd \
...
def yone_about_callback(update, context):
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Dewi*, a powerful group management bot built to help you manage your group easily.
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 444178185 and DONATION_LINK:
            update.effective_message.reply_text(
